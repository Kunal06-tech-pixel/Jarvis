// Web Audio API Sound Effects for Jarvis Voice Assistant
...
/**
 * Play a futuristic two-tone wake chime when "Hey Jarvis" or "Hey Siri" is detected
 */
...
/**
 * Play an acknowledgement chime when processing completes
 */
